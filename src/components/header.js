  ...
  render() {
    ...
    return (
      <StyledHeader className={`container clear ${className}`}>
        ...
        <Logo id="logo">
          <NavLink to={`/`} className="logo" activeClassName="on">
        ...
        <Nav>
          ...
          <NavLinkWithATag href={`https://github.com/boramyy`} className={[`nav-item`, `link`]} target="blank">
          ...
          <NavLinkWithATag href={`mailto:boramyyo@gmail.com`} className={[`nav-item`, `link`]}>
